...
<div class="cv-contact">
      France<br/>
<a href="mailto:asadmahdi.6.162@gmail.com">asadmahdi.6.162@gmail.com</a>

       | 

      <a href="mailto:asad.mahdi@etu.u-paris.fr">asad.mahdi@etu.u-paris.fr</a>
<br/>
LinkedIn
</div>
...
<div class="cv-entry">
<div class="cv-logo-stack" aria-label="NPAC partner institutions">
<img alt="Université Paris-Saclay" class="cv-institution-logo" loading="lazy" src="{{ '/assets/img/institutions/paris-saclay.png' | relative_url }}"/>
<img alt="Sorbonne Université" class="cv-institution-logo" loading="lazy" src="{{ '/assets/img/institutions/sorbonne-universite.png' | relative_url }}"/>
<img alt="Université Paris Cité" class="cv-institution-logo" loading="lazy" src="{{ '/assets/img/institutions/paris-cite.png' | relative_url }}"/>
</div>
...
<div class="cv-entry-content">
  ...
  <ul>
    ...
    <li>
     Utilizing this period of a suitable PhD search to pursue an additional Master’s in theoretical physics.
    </li>
    ...
    <li style="list-style: none;">
      <details>
        ...
        <ul>
          <li>
            Particle Physics
            (Quantum Field Theory up to QED and the Standard Model of Particle Physics)
          </li>
          ...
          <li>
            ...
            (Symmetry Breaking, Yang–Mills Theory, and Renormalization Group Analysis)
          </li>
...
<div class="cv-entry">
<div>
<img alt="University of Dhaka" class="cv-thumbnail" loading="lazy" src="{{ '/assets/img/institutions/university-of-dhaka.jpg' | relative_url }}"/>
</div>
<div class="cv-entry-content">
...
<div class="cv-entry">
<div>
<img alt="Notre Dame College" class="cv-thumbnail" loading="lazy" src="{{ '/assets/img/institutions/notre-dame-college.jpg' | relative_url }}"/>
</div>
<div class="cv-entry-content">
...
<div class="cv-entry">
<div>
<img alt="Ideal School and College" class="cv-thumbnail" loading="lazy" src="{{ '/assets/img/institutions/ideal-school-and-college.jpg' | relative_url }}"/>
</div>
<div class="cv-entry-content">
...
<a href="mailto:sylvain.marsat@l2it.in2p3.fr">sylvain.marsat@l2it.in2p3.fr</a>
</div>
<div class="cv-simple-entry">
<h3>Dr. Dhrubaditya Mitra</h3>
<p>
        Assistant Professor<br/>
        Stockholm University and Nordic Institute of Theoretical Physics<br/>
        NORDITA summer internship supervisor
      </p>
<a href="mailto:dhrubaditya.mitra@su.se">dhrubaditya.mitra@su.se</a>
</div>
<div class="cv-simple-entry">
...
<a href="mailto:nikolic@lpnhe.in2p3.fr">nikolic@lpnhe.in2p3.fr</a>
</div>
<div class="cv-simple-entry">
...
<a href="mailto:roucelle@apc.in2p3.fr">roucelle@apc.in2p3.fr</a>
</div>
</section>
<section class="cv-section">
